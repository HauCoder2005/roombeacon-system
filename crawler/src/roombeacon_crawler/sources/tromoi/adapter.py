...
class TromoiSourceAdapter(ScheduledHtmlSourceAdapter):
    INTERVAL_MINUTES = 5
    SOURCE_NAME = "tromoi"
    DOMAINS = ("tromoi.com", "www.tromoi.com")
    ...
    LISTING_PREFIXES = ("/tim-tro-", "/phong-tro")
    DETAIL_MARKERS = ("/phong-tro/",)
    LISTING_PARSER = TromoiListingParser
    DETAIL_PARSER = TromoiDetailParser
