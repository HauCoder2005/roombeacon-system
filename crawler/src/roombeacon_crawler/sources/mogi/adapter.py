...
class MogiPagination(QueryPagination):
    PARAMETER = "cp"
...
class MogiSourceAdapter(ScheduledHtmlSourceAdapter):
    ...
    LISTING_PREFIXES = ("/ho-chi-minh/thue-phong-tro",)
    DETAIL_MARKERS = ("-id",)
    LISTING_PARSER = MogiListingParser
    DETAIL_PARSER = MogiDetailParser
    PAGINATION = MogiPagination
