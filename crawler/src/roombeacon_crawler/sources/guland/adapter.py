...
class GulandSourceAdapter(ScheduledHtmlSourceAdapter):
    INTERVAL_MINUTES=10
    SOURCE_NAME="guland"; DOMAINS=("guland.vn", "www.guland.vn")
    DEFAULT_BASE_URL="https://guland.vn/cho-thue-phong-tro-tp-ho-chi-minh"
    CAPABILITIES=SourceCapabilities(access_profile=SourceAccessProfile.DISCOVERY_RESTRICTED, supports_pagination=False, historical_backfill_supported=False, preferred_fetch_strategy=FetchStrategy.HTTP, detail_fetch_supported=True)
    LISTING_PREFIXES=("/cho-thue-",); DETAIL_MARKERS=("/post/",)
    LISTING_PARSER=GulandListingParser; DETAIL_PARSER=GulandDetailParser; PAGINATION=QueryPagination
