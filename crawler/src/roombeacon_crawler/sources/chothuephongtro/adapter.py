...
class ChothuephongtroSourceAdapter(ScheduledHtmlSourceAdapter):
    ENABLED = True
    INTERVAL_MINUTES = 5
    SOURCE_NAME = "chothuephongtro"
    DOMAINS = ("chothuephongtro.me", "www.chothuephongtro.me")
    ...
    DETAIL_MARKERS = ("-pr",)
    LISTING_PARSER = ChothuephongtroListingParser
    DETAIL_PARSER = ChothuephongtroDetailParser
